pro convert_displacements, folder, reread = reread, vector = vector, global = global
  ...
  m1_init = apply_shift([m1_struct[0].x, m1_struct[0].y, m1_struct[0].z], $
    m1_shift[0 : 5], /flag)
  m2_init = apply_shift([m2_struct[0].x, m2_struct[0].y, m2_struct[0].z], $
    m2_shift[0 : 5], /flag)
  opt_init = apply_shift([opt_struct[0].x, opt_struct[0].y, opt_struct[0].z], $
    opt_shift[0 : 5], /flag)
